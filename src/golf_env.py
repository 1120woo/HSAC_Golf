...
class GolfEnv:
    ...
    IMG_PATH = "../resources/map2.png"  # 일자맵   372m
    IMG_SIZE = np.array([500, 500])
    IMG_SAMPLING_STRIDE = 1 * 3.571

    START_POS = np.array([253, 56])  # map2 par4맵
    ...
    CLUB_INFO = (
        ...
        ('DR',      182,  54 / 4,   8.6 / 4,    lambda d: 300 < d),
        ('W3',      165,  50 / 4,   7.6 / 4,    lambda d: 100 < d),
        ('W5',      155,  36 / 4,   6.6 / 4,    lambda d: 100 < d),
        ('I3',      146,  36 / 4,   5.9 / 4,    lambda d: 100 < d),
        ('I4',      137,  32.0 / 4,   5.5 / 4,    lambda d: 100 < d),
        ('I5',      128,  27.4 / 4,   5.1 / 4,    lambda d: 100 < d <= 300),
        ('I6',      119,  27.4 / 4,   4.8 / 4,    lambda d: 100 < d <= 300),
        ('I7',      110,  27.4 / 4,   4.5 / 4,    lambda d: 100 < d <= 200),
        ('I8',      101,  27.4 / 4,   4.3 / 4,    lambda d: 100 < d <= 200),
        ('I9',      87,  32.0 / 4,   3.9 / 4,    lambda d: 100 < d <= 200),
        ('PW10',    73,   36.6 / 4,   3.7 / 4,    lambda d: 70 < d <= 200),
        ('SW9',     60,     36.6 / 4,   3.3 / 4,    lambda d: d <= 200),
        ('SW8',     48,     32.0 / 4,   3.2 / 4,    lambda d: d <= 200),
        ('SW7',     41,     30 / 4,     3.1 / 4,    lambda d: d <= 200),
        ('SW6',     34,     20 / 4,     3.0 / 4,    lambda d: d <= 200),
        ('SW5',     27,     15 / 4,     2.9 / 4,    lambda d: d <= 200),
        ('SW4',     21,     10 / 4,     2.8 / 4,    lambda d: d <= 200),
        ('SW3',     15,     5 / 4,      2 / 4,    lambda d: d <= 200),
        ('SW2',     10,     3 / 4,      1 / 4,    lambda d: d <= 200),
        ('SW1',     5,      1 / 4,      0 ,    lambda d: d <= 200),
    )
