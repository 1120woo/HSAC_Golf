...
class GolfEnv:
    ...
    IMG_PATH = "../resources/map1_revised.png"  #휜 맵 368 m
    IMG_SIZE = np.array([500, 500])
    IMG_SAMPLING_STRIDE = 1 * 3.571

    START_POS = np.array([259, 92])  # map1 파란색은 269,60
    PIN_POS = np.array([281, 459])
    ...
    #     ('DR',      210.3,  54 / 7,   12 / 3,    lambda d: 300 < d),
    #     ('W3',      196.6,  50 / 7,   11.1 / 3,    lambda d: 100 < d),
    #     ('W5',      178.3,  36 / 7,   10.4 / 3,    lambda d: 100 < d),
    #     ('I3',      164.6,  36 / 7,   9.6 / 3,    lambda d: 100 < d),
    #     ('I4',      155.4,  32.0 / 7,   8.7 / 3,    lambda d: 100 < d),
    #     ('I5',      146.3,  27.4 / 7,   8.0 / 3,    lambda d: 100 < d <= 300),
    #     ('I6',      137.2,  27.4 / 7,   7.3 / 3,    lambda d: 100 < d <= 300),
    #     ('I7',      128.0,  27.4 / 7,   6.6 / 3,    lambda d: 100 < d <= 200),
    #     ('I8',      118.9,  27.4 / 7,   5.9 / 3,    lambda d: 100 < d <= 200),
    #     ('I9',      105.2,  32.0 / 7,   5.3 / 3,    lambda d: 100 < d <= 200),
    #     ('PW10',    96.0,   36.6 / 7,   4.7 / 3,    lambda d: 70 < d <= 200),
    #     ('SW9',     80,     36.6 / 7,   4.1 / 3,    lambda d: d <= 200),
    #     ('SW8',     70,     32.0 / 7,   3.6 / 3,    lambda d: d <= 200),
    #     ('SW7',     60,     30 / 7,     3.0 / 3,    lambda d: d <= 200),
    #     ('SW6',     50,     20 / 7,     2.4 / 3,    lambda d: d <= 200),
    #     ('SW5',     40,     15 / 7,     1.8 / 3,    lambda d: d <= 200),
    #     ('SW4',     30,     10 / 7,     1.2 / 3,    lambda d: d <= 200),
    #     ('SW3',     20,     5 / 7,      0.7 / 3,    lambda d: d <= 200),
    #     ('SW2',     10,     3 / 7,      0.3 / 3,    lambda d: d <= 200),
    #     ('SW1',     5,      1 / 7 ,      0,    lambda d: d <= 200),
    # )

    CLUB_INFO = (
        # NAME      DIST    DEV_X       DEV_Y       IS_DIST_PROPER(d: dist to pin)
        ('DR',      182,  54 / 3,   8.6 / 3,    lambda d: 300 < d),
        ('W3',      165,  50 / 3,   7.6 / 3,    lambda d: 100 < d),
        ('W5',      155,  36 / 3,   6.6 / 3,    lambda d: 100 < d),
        ('I3',      146,  36 / 3,   5.9 / 3,    lambda d: 100 < d),
        ('I4',      137,  32.0 / 3,   5.5 / 3,    lambda d: 100 < d),
        ('I5',      128,  27.4 / 3,   5.1 / 3,    lambda d: 100 < d <= 300),
        ('I6',      119,  27.4 / 3,   4.8 / 3,    lambda d: 100 < d <= 300),
        ('I7',      110,  27.4 / 3,   4.5 / 3,    lambda d: 100 < d <= 200),
        ('I8',      101,  27.4 / 3,   4.3 / 3,    lambda d: 100 < d <= 200),
        ('I9',      87,  32.0 / 3,   3.9 / 3,    lambda d: 100 < d <= 200),
        ('PW10',    73,   36.6 / 3,   3.7 / 3,    lambda d: 70 < d <= 200),
        ('SW9',     60,     36.6 / 3,   3.3 / 3,    lambda d: d <= 200),
        ('SW8',     48,     32.0 / 3,   3.2 / 3,    lambda d: d <= 200),
        ('SW7',     41,     30 / 3,     3.1 / 3,    lambda d: d <= 200),
        ('SW6',     34,     20 / 3,     3.0 / 3,    lambda d: d <= 200),
        ('SW5',     27,     15 / 3,     2.9 / 3,    lambda d: d <= 200),
        ('SW4',     21,     10 / 3,     2.8 / 3,    lambda d: d <= 200),
        ('SW3',     15,     5 / 3,      2.7 / 3,    lambda d: d <= 200),
