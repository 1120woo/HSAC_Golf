...
class GolfEnv:
    ...
    IMG_PATH = "../resources/map_hwang2.png"
    IMG_SIZE = np.array([500, 500])
    IMG_SAMPLING_STRIDE = 1 * 3.571

    START_POS = np.array([242, 74])  # map3 345m 파란색 기준
    PIN_POS = np.array([246, 419])
    ...
    # 6 + interp1d([0, 1, 3, 15, 100], [-1, -1, -1.3, -1.5, -2])(d))
    #  +
    # CLUB_INFO = (
    #     # NAME      DIST    DEV_X       DEV_Y       IS_DIST_PROPER(d: dist to pin)
    ...
    # CLUB_INFO = (
    #     # NAME      DIST    DEV_X       DEV_Y       IS_DIST_PROPER(d: dist to pin)
    #     ('DR',      182,    7.4*1.2,    7.4*0.9*1.2,    lambda d: 300 < d),
    #     ('W3',      165,    6.7*1.2,    6.7*0.9*1.2,    lambda d: 100 < d),
    #     ('W5',      155,    5.8*1.2,    5.8*0.9*1.2,    lambda d: 100 < d),
    #     ('I3',      146,    5.3*1.2,    5.3*0.9*1.2,    lambda d: 100 < d),
    #     ('I4',      137,    5*1.2,      5*0.9*1.2,      lambda d: 100 < d),
    #     ('I5',      128,    4.73*1.2,   4.73*0.9*1.2,   lambda d: 100 < d <= 300),
    #     ('I6',      119,    4.5*1.2,    4.5*0.9*1.2,    lambda d: 100 < d <= 300),
    #     ('I7',      110,    4.23*1.2,   4.23*0.9*1.2,   lambda d: 100 < d <= 200),
    #     ('I8',      101,    4.07*1.2,   4.07*0.9*1.2,   lambda d: 100 < d <= 200),
    #     ('I9',      87,     3.78*1.2,   3.78*0.9*1.2,   lambda d: 100 < d <= 200),
    #     ('PW10',    73,     3.62*1.2,   3.62*0.9*1.2,   lambda d: 70 < d <= 200),
    #     ('SW9',     60,     3.37*1.2,   3.37*0.9*1.2,   lambda d: d <= 200),
    #     ('SW8',     48,     3.23*1.2,   3.23*0.9*1.2,   lambda d: d <= 200),
    #     ('SW7',     41,     3.11*1.2,   3.11*0.9*1.2,   lambda d: d <= 200),
    #     ('SW6',     34,     3*1.2,      3*0.9*1.2,      lambda d: d <= 200),
    #     ('SW5',     27,     2*1.2,      2*0.9*1.2,      lambda d: d <= 200),
    #     ('SW4',     21,     1.5*1.2,    1.5*0.9*1.2,    lambda d: d <= 200),
    #     ('SW3',     15,     1*1.2,      1*0.9*1.2,      lambda d: d <= 200),
    #     ('SW2',     10,     0.5*1.2,    0.5*0.9*1.2,    lambda d: d <= 200),
    #     ('SW1',     5,      0,          0,              lambda d: d <= 200),
    # )
