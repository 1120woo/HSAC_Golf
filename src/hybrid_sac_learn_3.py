...
class SACagent(object):
    ...
    def train(self, max_episode_num):
        ...
        for ep in range(int(max_episode_num)):
            ...
            if ep < 100000:
                state = self.env.reset(randomize_initial_pos=True, max_timestep=15)
            ...
            if self.buffer.buffer_count() > 500:
                ...
                # np.savetxt('actor.txt',self.actor_loss_avg, fmt='%2d', delimiter=',', header='test')
                # np.savetxt('critic1.txt',self.critic1_loss_avg,fmt='%2d', delimiter=',', header='test')
                # np.savetxt('critic2.txt',self.critic2_loss_avg, fmt='%2d', delimiter=',', header='test')
